...
sed -i '$a src-git lienol https://github.com/Lienol/openwrt-package' feeds.conf.default #添加lienol仓库
...
# git clone https://github.com/kenzok8/small package/small #passwall依赖
